...
class TimeSpendingLogTest extends global.PHPUnit_Framework_TestCase {
  public static testStartsWithOptionallySuffixedTokenMethodDataProvider() {
  ...
  public static testAddZeroFilledDatesProvider() {
    return [
      [
        {
          "2013-03-28": "foo",
  ...
  public static testDurationFromLastProvider() {
    return [
      [
        1513096800,
        3,
  ...
  public testStartsWithOptionallySuffixedTokenMethod(
    haystack,
    keyword,
    suffix,
    expectedReturnValue,
  ...
  public testSecondsToDuration(seconds, expectedReturnValue) {
    const tlp = new TimeLogParser();
  ...
  public testDurationToMinutes(duration, expectedReturnValue) {
    const tlp = new TimeLogParser();
  ...
  public testParseGmtTimestampFromDateSpecifiedInSpecificTimezone(
    str,
    timezone,
  ...
  public testAddZeroFilledDates(times, expectedReturnValue) {
    const tlp = new TimeLogParser();
  ...
  public testDetectTimeStampAndSetTsAndDate(
    linefordatecheck,
  ...
  public testprocessAndAssertCorrectTimeSpendingLog(timeSpendingLogPath) {
